        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LibraryResources_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryItems_LibraryResources_ResourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_LibraryResources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "LibraryResources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remarks = table.Column<string>(type: "text", nullable: true),
                    TransferredByUserId = table.Column<int>(type: "integer", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustodyHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustodyHistories_Departments_FromDepartmentId",
                        column: x => x.FromDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustodyHistories_Departments_ToDepartmentId",
                        column: x => x.ToDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustodyHistories_InventoryItems_InventoryItemId",
                        column: x => x.InventoryItemId,
                        principalTable: "InventoryItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustodyHistories_Users_TransferredByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DigitalContents_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DigitalContentRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DigitalContentRequests_DigitalContents_DigitalContentId",
                        column: x => x.DigitalContentId,
                        principalTable: "DigitalContents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DigitalContentRequests_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DigitalContentRequests_Users_ApprovedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustodyHistories_FromDepartmentId",
                table: "CustodyHistories",
                column: "FromDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CustodyHistories_InventoryItemId",
                table: "CustodyHistories",
                column: "InventoryItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CustodyHistories_ToDepartmentId",
                table: "CustodyHistories",
                column: "ToDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_CustodyHistories_TransferredByUserId",
                table: "CustodyHistories",
                column: "TransferredByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalContentRequests_ApprovedByUserId",
                table: "DigitalContentRequests",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalContentRequests_DigitalContentId",
                table: "DigitalContentRequests",
                column: "DigitalContentId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalContentRequests_EmployeeId",
                table: "DigitalContentRequests",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_DigitalContents_UploadedByUserId",
